...
class MemberServiceMockitoTest {
    ...
    @Test
    void getMembers() {
        Member m1 = new Member("m1", "m1@a.dk", "test12", "bb", "Olsen", "test vej 34", "Lyngby", "2800");
        Member m2 = new Member("m2", "m2@a.dk", "test12", "aa", "hansen", "test vej 34", "Lyngby", "2800");
    ...
    @Test
    void addMember() {
        Member m1 = new Member("m1", "test12", "m1@a.dk", "bb", "Olsen", "test vej 34", "Lyngby", "2800");
        ...
        Mockito.when(memberRepository.existsById(any(String.class))).thenReturn(false);
        Mockito.when(memberRepository.existsByEmail(any(String.class))).thenReturn(false);
